...
const Projects = () => {
  ...
  useEffect(()=>{
    const upgradeCardsToShow = ()=>{
      ...
      window.addEventListener('resize', upgradeCardsToShow );
      return () => window.removeEventListener('resize', upgradeCardsToShow );
  ...
  return (
    ...
    id='Projects'>
      ...
      <div className='flex justify-end itemjs-center mb-8'>
